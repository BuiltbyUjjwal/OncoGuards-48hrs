            ...
            <section className="reports-section">
              <div className="section-header">
                ...
                <div>
                  ...
                  <p className="section-subtitle">{t('reports.aiReportsSub', 'Health evaluations generated by OncoGuards AI')}</p>
                </div>
              </div>
              ...
              {allAssessments.length === 0 ? (
                <div className="empty-state">
                  ...
                  <p>{t('reports.noAiReports', "You haven't completed any health assessments yet.")}</p>
                  <button 
                    type="button"
                      ...
                      <li key={assessment.id} className="report-list-item">
                        <div className="report-info">
                          <div className="report-title-row">
                            <h3 className="report-title">{t('reports.healthRiskAssessment', 'Health Assessment')}</h3>
