...
export const ScreeningHistorySectionPage: React.FC<ScreeningHistorySectionPageProps> = ({
  ...
  useEffect(() => {
    if (isHydrated && assessmentState.screeningHistory) {
      setHasPreviousScreening(assessmentState.screeningHistory.hasPreviousScreening || '');
      setScreeningsDone(assessmentState.screeningHistory.screeningsDone || []);
      setLastCancerScreening(assessmentState.screeningHistory.lastCancerScreening || '');
    }
  }, [isHydrated, assessmentState.screeningHistory]);
            ...
            <div className="medical-form-card">
              ...
              <form onSubmit={handleNext} className="questionnaire-form" noValidate>
                ...
                <div className="form-actions-footer">
                  ...
                  >
                    <span>{t('screening.reviewHealthProfile', 'Review Assessment →')}</span>
                  </button>
                </div>
              </form>
            </div>
