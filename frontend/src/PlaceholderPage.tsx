...
> = {
  ...
  profile: {
    ...
    subtitle: 'Personal Health Information & Clinical Demographics',
    description:
      'Manage your verified patient contact information, emergency contacts, primary care provider details, and privacy consent preferences.',
...
export const PlaceholderPage: React.FC<PlaceholderPageProps> = ({
  ...
  const config = pageConfigs[pageKey] || {
    ...
    description: 'This healthcare module is configured and connected to your patient portal.',
