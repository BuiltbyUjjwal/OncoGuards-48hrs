...
export const SymptomsSectionPage: React.FC<SymptomsSectionPageProps> = ({
  ...
  const { state: assessmentState, updateSymptoms, isFemale, isHydrated } = useAssessment();

  const SYMPTOM_CATEGORIES: SymptomCategory[] = [
    {
      id: 'lung',
      title: t('symptoms.lungTitle', 'Check Your Lung Health'),
    ...
    {
      id: 'breast',
      title: t('symptoms.breastTitle', 'Check Your Breast Health'),
    ...
    {
      id: 'oral',
      title: t('symptoms.oralTitle', 'Check Your Oral Health'),
    ...
    {
      id: 'cervical',
      title: t('symptoms.cervicalTitle', 'Check Your Cervical Health'),
  ...
  useEffect(() => {
    if (isHydrated && assessmentState.symptoms) {
      setSelectedSymptoms(assessmentState.symptoms.selectedSymptoms || []);
      setSymptomDurations(assessmentState.symptoms.symptomDurations || {});
      setSymptomSeverities(assessmentState.symptoms.symptomSeverities || {});
    }
  }, [isHydrated, assessmentState.symptoms]);
        ...
        <div className="section-container" style={{ maxWidth: '920px', margin: '0 auto' }}>
          <div className="symptoms-form-card">
            ...
            <form onSubmit={handleSaveAndAnalyze} className="questionnaire-form" noValidate>
              ...
              {/* Form Actions Footer */}
              <div className="symptoms-actions-footer" style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap', marginTop: '24px' }}>
                <button
                  type="button"
