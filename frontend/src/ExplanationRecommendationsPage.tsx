...
export const ExplanationRecommendationsPage: React.FC<ExplanationRecommendationsPageProps> = ({
  ...
  const { state: assessmentState, resetAssessment, isFemale } = useAssessment();
  ...
  const handleStartNewAssessment = () => {
    if (window.confirm('Are you sure you want to start a new health profile? Your current responses will be reset.')) {
      resetAssessment();
          ...
          <div className="exp-hero-card">
            ...
            <div className="result-header-group">
              ...
              <p className="exp-hero-subtext">
                ...
                <strong>{basicInfo.fullName || 'Registered Patient'}</strong> based on current oncology
              ...
              <div className="next-steps-stack">
                ...
                <div className="next-step-card">
                  ...
                  <div className="next-step-content">
                    ...
                    <p className="next-step-desc">
                      {t('explanation.step4Desc', 'Update your OncoGuards health profile annually or whenever significant changes in your health, lifestyle, or family history occur.')}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="exp-actions-footer">
            ...
            <div className="exp-actions-group">
              ...
              >
                ...
                <span>{t('detailedReport.updateProfile', 'Update Health Profile')}</span>
              </button>
