...
export const initialAssessmentState: AssessmentState = {
  ...
  medicalHistory: {
    ...
    hasAllergy: false,
    hasAnxiety: false,
    hasFamilyCancerHistory: 'No',
    familyCancerTypes: [],
    familyCancerOtherText: '',
    medicalConditions: [],
    hasPreviousCancerDiagnosis: 'No',
    previousCancerType: '',
  ...
  womenOnly: {
    agePeriodsBegan: '12–14',
    firstPeriodAge: '12–14',
    menopauseStatus: 'Pre-menopausal (regular periods)',
    menopauseAge: '',
    hadSurgicalMenopause: 'Natural',
    pregnancyHistory: 'Never pregnant (nulliparous)',
    ageAtFirstBirth: '<30',
    hadChildren: 'No',
    oralContraceptiveUse: 'Never used birth control pills',
    oralContraceptiveYears: 0,
    hormoneReplacementTherapy: 'Never used hormone therapy',
    usedHormoneTherapy: 'No',
    usedIud: 'No',
    iudYears: 0,
    hpvVaccinationStatus: 'Never received HPV vaccine (Gardasil / Cervavac)',
    isHpvPositive: false,
    isScreeningOverdue: false,
    priorMammogram: 'No',
    lastMammogramResult: 'Unknown',
    breastDensity: 'Unknown',
    numSexualPartners: '',
    firstIntercourseAge: 17,
    raceEthnicity: 'Unknown',
    isHispanic: 'No',
  },
  screeningHistory: {
    hasPreviousScreening: 'No',
    screeningsDone: [],
    lastCancerScreening: '',
  },
  symptoms: {
