...
export const DetailedReportPage: React.FC<DetailedReportPageProps> = ({
  ...
  const handleStartNewAssessment = () => {
    if (
      window.confirm(
        'Are you sure you want to start a new health profile? Your current responses will be reset.'
      )
    ) {
      resetAssessment();
            ...
            {hasAssessmentData && (
              <div className="doc-patient-meta-grid">
                <div className="doc-meta-item">
                  ...
                  <span className="doc-meta-value">{basicInfo.fullName || 'Registered Patient'}</span>
                </div>
                <div className="doc-meta-item">
