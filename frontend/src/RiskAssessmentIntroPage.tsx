            ...
            <div className="intro-hero-card">
              ...
              <div className="intro-heading-group" style={{ marginBottom: '24px' }}>
                ...
                <p className="intro-description-text">
                  Your base assessment is already saved. Proceed directly to log or update any physical symptoms
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                      <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: '#0F172A', margin: 0 }}>
                        {basicInfo.fullName?.trim() || 'Registered User'}
                      </h3>
            ...
            <div className="intro-hero-card">
              ...
              <div className="intro-progress-header">
                <div className="intro-step-pill">
                  ...
                  <span className="step-pill-text">{t('dashboard.healthProfileSetup', 'Assessment Setup • Overview')}</span>
                </div>
                <div className="intro-meta-tags">
                  <span className="intro-meta-item">
                    <ClockIcon size={14} />
              ...
              <div className="intro-heading-group">
                <h1 className="intro-main-title">{t('dashboard.startAssessmentTitle', 'Complete Your Assessment')}</h1>
                <p className="intro-description-text">
                  Complete your personal, lifestyle, medical, family, and screening information once to establish your base assessment. You can then log current symptoms anytime.
                </p>
              </div>

              {/* Checklist of 5 Assessment Sections */}
              <div className="sections-checklist-wrapper" role="region" aria-label="Assessment Sections Checklist">
                <div className="checklist-header-row">
                  <h2 className="checklist-title">{t('dashboard.healthProfileSections', 'Assessment Sections')}</h2>
              ...
              <div className="intro-actions-bar">
                ...
                >
                  ...
                  <span>Start Assessment (Step 1) →</span>
                </button>
              </div>
            </div>
          )}
