...
export const ProfilePage: React.FC<ProfilePageProps> = ({ onNavigate, onLogout }) => {
  ...
  const { state: assessmentState, pastAssessments, resetAssessment } = useAssessment();
          ...
          <div className="profile-demographics-grid">
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.fullName || <span className="profile-field-empty">Not provided yet</span>}
              </span>
            </div>
            ...
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.email || currentUser?.email || <span className="profile-field-empty">Not provided</span>}
              </span>
            </div>
            ...
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.phoneNumber || <span className="profile-field-empty">Not provided</span>}
              </span>
            </div>
            ...
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.age ? `${basicInfo.age} years` : <span className="profile-field-empty">Not provided</span>}
              </span>
            </div>
            ...
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.biologicalSex || <span className="profile-field-empty">Not selected</span>}
              </span>
            </div>
            ...
            <div className="profile-field-item">
              ...
              <span className="profile-field-value">
                {basicInfo.city || basicInfo.state ? (
                  ...
                  <span className="profile-field-empty">Not specified</span>
                )}
              </span>
            </div>
          </div>
