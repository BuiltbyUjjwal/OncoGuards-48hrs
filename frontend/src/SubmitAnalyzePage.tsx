...
export const SubmitAnalyzePage: React.FC<SubmitAnalyzePageProps> = ({
  ...
  const STAGES: AnalysisStage[] = [
    { id: 1, label: t('analyzing.stage1', 'Health Profile verified'), sublabel: t('analyzing.stage1Sub', 'Structuring personal, lifestyle, medical, & screening records') },
  ...
  useEffect(() => {
    ...
    const runAnalysis = async () => {
      ...
      const factors = [
        {
          name: 'Primary Health Profile Determinants',
    ...
    <main className="analyzing-page-root">
      <div className="analyzing-card">
        ...
        <div className="analyzing-header-group">
          ...
          <h1 className="analyzing-title">{t('analyzing.title', 'Analyzing Your Health Profile')}</h1>
